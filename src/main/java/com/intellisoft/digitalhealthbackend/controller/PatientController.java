...
public class PatientController {
    ...
    @PostMapping()
    public ResponseEntity<UniversalResponse>createPatient ( @Valid @RequestBody PatientWrapper patientWrapper){
    ...
    public ResponseEntity<UniversalResponse>addPatientEncounter( @PathVariable(name = "patientId") Long patientId, @Valid @RequestBody EncounterWrapper encounterWrapper){
    ...
    public ResponseEntity<UniversalResponse>addEncounterObservation(@PathVariable(name = "encounterId") Long encounterId,@Valid @RequestBody ObservationWrapper observationWrapper){
    ...
    public ResponseEntity<UniversalResponse>endPatientEncounter(@PathVariable(name = "encounterId") Long encounterId,@Valid @RequestBody EndEncounterWrapper endEncounter){
